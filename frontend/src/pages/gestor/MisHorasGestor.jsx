...
export default function MisHorasGestor() {
  ...
  function handleRecargar(semanaInicio, proyectoId) {
    navigate('/gestor/cargar', { state: { semanaInicio, proyectoId } });
  }
