...
> **Source change:** `refactor-backend-ts-prisma-modular`
> **Last synced:** 2026-05-19

Garantías observables del contrato HTTP que el backend debe preservar y que la suite de tests de contrato (supertest) verifica antes y después de cada módulo refactorizado.
