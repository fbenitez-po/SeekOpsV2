...
router.post(
  ...
  [
    ...
    body('categorias_proyecto_ids').optional({ nullable: true }).isArray().withMessage('categorias_proyecto_ids debe ser un array'),
    body('categorias_proyecto_ids.*').isUUID().withMessage('cada categoría debe ser un UUID válido'),
